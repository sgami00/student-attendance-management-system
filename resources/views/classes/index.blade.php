...
<style>
    body { background: #eef2ff; background-image: none; }
    ...
    <div class="relative px-8 py-8 flex justify-between items-center">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('students.all') }}"
                class="bg-white bg-opacity-20 border border-white border-opacity-40 text-white font-bold text-sm px-5 py-2.5 rounded-xl hover:bg-white hover:text-indigo-700 transition shadow-md flex items-center gap-2 whitespace-nowrap">
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 flex items-center gap-3">
        <div class="bg-indigo-100 p-2.5 rounded-lg"><i class="fa-solid fa-layer-group text-indigo-600 text-lg"></i></div>
        <div>
    ...
    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 flex items-center gap-3">
        <div class="bg-emerald-100 p-2.5 rounded-lg"><i class="fa-solid fa-users text-emerald-600 text-lg"></i></div>
        <div>
    ...
    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 flex items-center gap-3">
        <div class="bg-amber-100 p-2.5 rounded-lg"><i class="fa-solid fa-calendar-check text-amber-600 text-lg"></i></div>
        <div>
    ...
    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 flex items-center gap-3">
        <div class="bg-purple-100 p-2.5 rounded-lg"><i class="fa-solid fa-qrcode text-purple-600 text-lg"></i></div>
        <div>
                    ...
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <div class="flex space-x-1 bg-gray-50 p-1 rounded-lg border border-gray-100">
                            ...
                            <form action="{{ route('classes.destroy', $class->id) }}" method="POST"
                                ...
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-gray-400 hover:text-red-600 p-1.5 rounded-md transition hover:bg-red-50" title="Delete Class">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
